...
#line 147 "calc.parser.cc"
  ...
  CalcParser::CalcParser (Calculator &calculator_yyarg)
#if YYDEBUG
    : yydebug_ (false),
      yycdebug_ (&std::cerr),
#else
    :
#endif
      calculator (calculator_yyarg)
  {}

  CalcParser::~CalcParser ()
  {}

  CalcParser::syntax_error::~syntax_error () YY_NOEXCEPT YY_NOTHROW
  {}
  ...
  template <typename Base>
  CalcParser::symbol_kind_type
  CalcParser::basic_symbol<Base>::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  template <typename Base>
  bool
  CalcParser::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  // by_kind.
  CalcParser::by_kind::by_kind () YY_NOEXCEPT
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  CalcParser::by_kind::by_kind (by_kind&& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  CalcParser::by_kind::by_kind (const by_kind& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {}

  CalcParser::by_kind::by_kind (token_kind_type t) YY_NOEXCEPT
  ...
  void
  CalcParser::by_kind::clear () YY_NOEXCEPT
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }

  void
  CalcParser::by_kind::move (by_kind& that)
  {
    kind_ = that.kind_;
    that.clear ();
  }
  ...
  CalcParser::symbol_kind_type
  CalcParser::by_kind::kind () const YY_NOEXCEPT
  {
    return kind_;
  }
  ...
  CalcParser::symbol_kind_type
  CalcParser::by_kind::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  // by_state.
  CalcParser::by_state::by_state () YY_NOEXCEPT
    : state (empty_state)
  {}

  CalcParser::by_state::by_state (const by_state& that) YY_NOEXCEPT
    : state (that.state)
  {}

  void
  CalcParser::by_state::clear () YY_NOEXCEPT
  {
    state = empty_state;
  }

  void
  CalcParser::by_state::move (by_state& that)
  {
    state = that.state;
    that.clear ();
  }

  CalcParser::by_state::by_state (state_type s) YY_NOEXCEPT
    : state (s)
  {}

  CalcParser::symbol_kind_type
  CalcParser::by_state::kind () const YY_NOEXCEPT
  {
  ...
  CalcParser::stack_symbol_type::stack_symbol_type ()
  {}
  ...
  template <typename Base>
  void
  CalcParser::yy_destroy_ (const char* yymsg, basic_symbol<Base>& yysym) const
  {
    if (yymsg)
  ...
  template <typename Base>
  void
  CalcParser::yy_print_ (std::ostream& yyo, const basic_symbol<Base>& yysym) const
  {
  ...
  void
  CalcParser::yypush_ (const char* m, YY_MOVE_REF (stack_symbol_type) sym)
  {
    if (m)
  ...
  void
  CalcParser::yypush_ (const char* m, state_type s, YY_MOVE_REF (symbol_type) sym)
  {
#if 201103L <= YY_CPLUSPLUS
  ...
  void
  CalcParser::yypop_ (int n) YY_NOEXCEPT
  {
    yystack_.pop (n);
  }
...
#if YYDEBUG
  std::ostream&
  CalcParser::debug_stream () const
  {
    return *yycdebug_;
  }

  void
  CalcParser::set_debug_stream (std::ostream& o)
  {
    yycdebug_ = &o;
  }


  CalcParser::debug_level_type
  CalcParser::debug_level () const
  {
    return yydebug_;
  }

  void
  CalcParser::set_debug_level (debug_level_type l)
  {
    yydebug_ = l;
  }
#endif // YYDEBUG

  CalcParser::state_type
  CalcParser::yy_lr_goto_state_ (state_type yystate, int yysym)
  {
  ...
  bool
  CalcParser::yy_pact_value_is_default_ (int yyvalue) YY_NOEXCEPT
  {
    return yyvalue == yypact_ninf_;
  }

  bool
  CalcParser::yy_table_value_is_error_ (int yyvalue) YY_NOEXCEPT
  {
...
#endif // YY_EXCEPTIONS
          {
            yyla.kind_ = yytranslate_ (yylex (&yyla.value, &yyla.location, calculator));
          }
#if YY_EXCEPTIONS
...
#line 843 "calc.parser.cc"
  ...
  void
  CalcParser::error (const syntax_error& yyexc)
  {
  ...
  std::string
  CalcParser::yytnamerr_ (const char *yystr)
  {
    if (*yystr == '"')
      {
        std::string yyr;
  ...
  std::string
  CalcParser::symbol_name (symbol_kind_type yysymbol)
  {
  ...
  // CalcParser::context.
  CalcParser::context::context (const CalcParser& yyparser, const symbol_type& yyla)
    : yyparser_ (yyparser)
    , yyla_ (yyla)
  {}

  int
  CalcParser::context::expected_tokens (symbol_kind_type yyarg[], int yyargn) const
  {
  ...
  int
  CalcParser::yy_syntax_error_arguments_ (const context& yyctx,
  ...
  std::string
  CalcParser::yysyntax_error_ (const context& yyctx) const
  {
    // Its maximum.
    enum { YYARGS_MAX = 5 };
...
#undef YYCASE_
  ...
  const signed char CalcParser::yypact_ninf_ = -9;

  const signed char CalcParser::yytable_ninf_ = -1;
  ...
  const signed char
  CalcParser::yydefact_[] =
  {
       0,     3,     7,     8,     0,     0,     5,     9,     0,    10,
      13,    16,     0,     0,     1,     6,     0,     0,     0,     0,
       2,     4,    11,    12,    14,    15
  };
  ...
  CalcParser::yytable_[] =
  {
      15,     1,     2,     3,    18,    19,     4,    14,    22,    23,
      16,    17,    24,    25,    13,    20,     0,    21
  };

  const signed char
  CalcParser::yycheck_[] =
  {
       8,     3,     4,     5,     4,     5,     8,     0,    16,    17,
       6,     7,    18,    19,     4,    10,    -1,     9
  };
  ...
  const char*
  const CalcParser::yytname_[] =
  {
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "ADD", "SUB",
  "MUL", "DIV", "LEFT_P", "RIGHT_P", "ENDLINE", "$accept", "start",
  ...
  void
  CalcParser::yy_stack_print_ () const
  {
    *yycdebug_ << "Stack now";
  ...
  void
  CalcParser::yy_reduce_print_ (int yyrule) const
  {
  ...
  CalcParser::symbol_kind_type
  CalcParser::yytranslate_ (int t) YY_NOEXCEPT
  {
